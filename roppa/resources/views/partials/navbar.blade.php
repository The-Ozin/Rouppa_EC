...
<nav class="navbar navbar-expand-lg navbar-light" style="background-color: rgba(90, 29, 0); position: sticky; top: 0; z-index: 1000;">
    ...
    <div class="container-fluid">
        ...
        <div class="d-flex align-items-center">
            <!-- Navbar title -->
            <div class="navbar-brand mt-2 mt-lg-0" style="font-family: 'Noto Serif Display', serif; font-weight: bold; font-style: italic; color: white;">
                Rouppa
            </div>
        ...
        <div class="d-flex align-items-center">
            ...
            <div class="dropdown">
                ...
                >
                    <li>
                        <a class="dropdown-item" href="../user/user-register.blade.php">My profile</a>
                    </li>
                    <li>
